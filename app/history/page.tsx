...
export default function HistoryPage(){
  ...
  useEffect(()=>{supabase?.auth.getUser().then(({data})=>{setUser(data.user);if(!data.user)setLoading(false)})},[]);
  ...
  return <main className="history-page"><header><Link href="/" className="back-link"><ArrowLeft/> Today</Link><div className="brand"><span className="brand-mark"><Check weight="bold"/></span><span>eats</span></div></header>
