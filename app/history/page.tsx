...
export default function HistoryPage(){
  ...
  return <main className="history-page"><header><Link href="/" className="back-link"><ArrowLeft/> Today</Link><div className="brand"><img className="brand-logo" src="/eats-logo.png" alt=""/><span>eats</span></div></header>
